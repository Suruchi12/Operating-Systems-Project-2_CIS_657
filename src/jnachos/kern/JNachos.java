...
public abstract class JNachos {
	...
	public static OpenFile SwapSpaceFile;
	public static int swapCounter;
	public static LinkedList<TranslationEntry> SchedulingFIFO = new LinkedList<TranslationEntry>();
	...
	public static void initialize(String args[]) {
		...
		SwapSpaceFile = mFileSystem.open("SwapSpace");
